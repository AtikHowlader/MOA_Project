...
public class TC_20 extends Abstract_Class {

    @Test
    public void compensationAmountsTest () throws InterruptedException {
        ...
        Base_Class.maximumLimitsPage().compensationAmountsTable();
    }//end of test
