...
public class TC_15 extends Abstract_Class {

    @Test
    public void fpaContribWithdrawalTest () throws InterruptedException {
        ...
        Base_Class.fpaSubHeader().fpaContribWithdrawalPage();
    }//end of test
